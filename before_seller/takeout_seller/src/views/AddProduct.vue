    ...
    <div style="margin-top: 60px;margin-left:130px;width: 600px;height: 500px;border: 0px solid red;" >
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="商品分类" prop="categoryType">
                <el-select style="margin-left: -305px" v-model="ruleForm.categoryType" placeholder="请选择分类">
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post('http://localhost:8383/product/seller/product/add',_this.ruleForm).then(function(resp){
                            if(resp.data.code == 0){
